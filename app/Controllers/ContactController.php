...
//        Send confirmation mail
            ...
            $from = "mijnveiligheid1@gmail.com";
            $name = $request->getParam('name');
            $csubject = $request->getParam('subject');
            $number = $request->getParam('number');
            $cmessage = $request->getParam('message');
            ...
            $subject = "Bevestingsmail mijnveiligheid.com";

            $logo = 'http://wethemez.com/test-html/consultplus/img/logo-black.png';
            $link = 'https://www.mijnveiligheid.com';
            ...
            $body .= "<a href='{$link}'><img src='{$logo}' alt=''></a><br><br>";
            $body .= "</td></tr></thead><tbody><tr>";
            $body .= "<tr><td colspan='2' style='border:none;'><strong>We hebben u bericht goed ontvangen en beantwoorden deze zo spoedig mogelijk</strong></td></tr>";
            $body .= "<td style='border:none;'><strong>Name:</strong> {$name}</td>";
